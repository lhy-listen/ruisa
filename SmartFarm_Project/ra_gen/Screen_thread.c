...
#include "Screen_thread.h"
                ...
                static uint8_t Screen_thread_stack[1024] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #else
                static uint8_t Screen_thread_stack[1024] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.Screen_thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #endif
                #endif
...
extern uint32_t g_fsp_common_thread_count;
                ...
                const rm_freertos_port_parameters_t Screen_thread_parameters =
                {
                    .p_context = (void *) NULL,
                };
